...
export default function Home() {
  ...
  // NEW: Handle Download Logic
  const handleDownload = (e: React.MouseEvent) => {
    // We don't preventDefault so the 'download' attribute still triggers
    // but we can add tracking or custom logic here if needed.
    const downloadUrl = "https://github.com/Flamiano/moneyga-app/releases/download/v1.0.0/MoneyGa.apk";
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="w-full lg:w-1/2">
                {/* UI REFINEMENT: Enhanced Security Visual */}
                <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-white/10 shadow-2xl relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-4">
                    <ShieldCheck className="w-10 h-10 text-emerald-500/10 group-hover:text-emerald-500/20 transition-colors" />
                  </div>
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                    Secure Privacy Masking
                  </h4>
                  <div className="space-y-6">
                    <DataField label="Full Name" value="J**** F*****" />
                    <DataField label="Mobile Number" value="09*******" />
                    <DataField label="Email Address" value="j*******@gmail.com" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-4">
              {isAndroid ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-700/30 rounded-full border border-emerald-500/20 text-[10px] font-bold uppercase tracking-widest">
                    <Smartphone className="w-3 h-3" />
                    iOS Support: 2026 Q3
                  </div>
                </div>
...
function DataField({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center justify-between bg-slate-50 dark:bg-black/20 p-4 rounded-xl border border-slate-100 dark:border-white/5 group-hover:border-emerald-500/30 transition-colors">
